...
parser.add_argument('-ad','--attributor_dims', nargs='+', type=int, help='Dimensions for attributor.', default=[332,1])
parser.add_argument('-ed','--embedding_dims', nargs='+', type=int, help='Dimensions for embeddings.', default=[166,166,166])
#parser.add_argument('-ad','--attributor_dims', nargs='+', type=int, help='Dimensions for attributor.', default=[182,1])
#parser.add_argument('-ed','--embedding_dims', nargs='+', type=int, help='Dimensions for embeddings.', default=[16,16,16])
...
if dims[-1] + 166 != attributor_dims[0] - dim_add:
...
for k, (train_loader, test_loader) in enumerate(data):
    attributor_dims = copy.deepcopy(attributor_dims_init)
