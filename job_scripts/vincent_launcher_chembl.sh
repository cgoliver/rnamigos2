...
python_cmd="python experiments/train.py
                  ...
                  device=cpu
                  name=final_chembl_fp_dim64_simhungarian_prew1"
python_cmd=$(echo $python_cmd) # to replace newlines
CMDARRAY+=("$python_cmd")
...
python_cmd="python experiments/train.py
                    ...
                    train.simfunc=None
                    train.rnamigos1_split=-1
                    name=final_chembl_dock_dim64_simhungarian_prew0
                    device=1
                    train.num_workers=2"
python_cmd=$(echo $python_cmd) # to replace newlines
CMDARRAY+=("$python_cmd")
...
python_cmd="python experiments/train.py
                    ...
                    train.pretrain_weight=1
                    train.simfunc=hungarian
                    name=final_chembl_dock_dim64_simhungarian_prew1
                    device=2
                    train.num_workers=2"
python_cmd=$(echo $python_cmd) # to replace newlines
CMDARRAY+=("$python_cmd")
